...
import 'package:myapp/view/paymentscreen.dart';
import 'package:ndialog/ndialog.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:myapp/view/delivery.dart';
...
class CheckOutPage extends StatefulWidget {
  ...
  const CheckOutPage(
      {Key? key, required this.email, required this.total, required this.user})
      : super(key: key);
...
class _CheckOutPageState extends State<CheckOutPage> {
  ...
  Future<void> _payDialog() async {
    ...
    await Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) =>
            PaymentScreen(user: widget.user, total: widget.total),
      ),
    );
  }
